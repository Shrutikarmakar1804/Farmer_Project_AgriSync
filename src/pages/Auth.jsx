                    ...
                    <div className="space-y-4 animate-fadeIn">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <input name="district" type="text" value={formData.district} onChange={handleInputChange} placeholder="District" className="block w-full px-3 py-3 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-green-500 text-sm transition-all shadow-sm" />
                        ...
                        <div>
                          ...
                          <input name="pinCode" type="text" value={formData.pinCode} onChange={handleInputChange} placeholder="6-digits" className="block w-full px-3 py-3 border border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-green-500 text-sm transition-all shadow-sm" />
