...
const items = [
  {
    ...
    main: '1800-000-2026',
    sub: 'Talk to procurement support',
    description:
      'Get assistance with procurement, mandi processes, token status, and general farmer queries.',
  },
  {
    icon: 'calendar',
    title: 'Slot Assistance',
    main: 'Booking & Rescheduling',
    sub: 'Guidance available',
    description:
      'Need to change your arrival slot or having trouble with booking? Our support team can guide you.',
  },
  {
    icon: 'check',
    title: 'Payment Support',
    main: 'Payment Status',
    sub: 'Transaction assistance',
    description:
      'Get help understanding payment status, completed transactions, or procurement payment questions.',
  },
]
