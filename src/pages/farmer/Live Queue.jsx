...
const activity = [
  ['AG-1021', 'Ramesh Kumar', 'Verified', '2 min ago'],
  ['AG-1022', 'Sanjay Das', 'Quality Check', '5 min ago'],
  ['AG-1023', 'Anita Devi', 'Verified', '8 min ago'],
]
...
export default function LiveQueue({
  ...
  const progress = Math.max(25, Math.min(100, 100 - ahead * 12))
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Mandi operations · Kolkata Central
        </span>
      </div>
      ...
      >
        ...
        >
          ...
          >
            Your token will be called when the gate lane is ready.
          </p>
      ...
      >
        {[
          ['24', 'Farmers currently queued', 'users'],
          ['08 min', 'Average processing time', 'clock'],
          ['94%', 'Queue flow efficiency', 'activity'],
