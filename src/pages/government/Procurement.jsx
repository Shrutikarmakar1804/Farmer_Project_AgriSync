...
const defaultData = [
  ['Wheat', '1,240 q', '₹32.04L', '96%'],
  ['Paddy', '1,580 q', '₹37.40L', '94%'],
  ['Mustard', '520 q', '₹32.24L', '91%'],
  ['Maize', '690 q', '₹16.48L', '87%'],
]

export default function Procurement({ procurement = defaultData }) {
  const data = procurement?.length ? procurement : defaultData

  const totalQuantity = '4,030 q'
  const totalValue = '₹118.16L'
  const averageCompliance = '92%'
