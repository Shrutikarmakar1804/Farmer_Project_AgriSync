...
const rows = [
  ['TK-1081', 'Kahan Namer', 'Gensen'],
  ['TK-1082', 'Gahar Kahari', 'Gensen'],
  ['TK-1083', 'Boghal Namar', 'Geason'],
]

const alerts = [
  'Mandis exceed 90% capacity',
  'Durgapur Mandi is operating near peak load',
  'Farmer wait time rising in Siliguri',
  'Mandi Khwarande exceeds 90% capacity',
  'Mandi Gahar Rahari exceeds 90% capacity',
]

export default function MandiMonitoring({ mandis = [] }) {
  const [showTransactions, setShowTransactions] = useState(false)

  const onlineCenters = mandis.length || 4
